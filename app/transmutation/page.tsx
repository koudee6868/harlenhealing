...
// --- Component nội bộ cho phần giới thiệu chính ---
const defaultPost = {
            ...
            <div className="container">
                <div className="prose dark:prose-invert mx-auto max-w-3xl">
                    ...
                    <p className="text-muted-foreground mt-2 text-lg">
                        Gỡ bỏ niềm tin giới hạn<br />
                        Kết nối với bản thân thật<br />
...
// --- Component nội bộ cho phần Call to Action ---
interface CtaProps {
    heading: string;
    description: string;
    buttons?: {
...
const CtaSection = ({
    ...
    buttons = {
        primary: { text: "Đặt lịch hẹn", url: "https://www.shadcnblocks.com", },
        secondary: { text: "Khám phá thêm", url: "/", },
    },
}: CtaProps) => {
    return (
...
// *** ĐÂY LÀ COMPONENT TRANG CHÍNH, DUY NHẤT ĐƯỢC EXPORT DEFAULT ***
export default function TransmutationPage() {
    return (
        <main>
            <TransmutationSection />
            <CtaSection
                heading={"SẴN SÀNG KHÁM PHÁ THÊM VỀ BẠN?"}
                description={"Không chỉ là một cuộc trò chuyện, đây là không gian an toàn để bạn khám phá và thấu hiểu bản thể đích thực của chính mình"}
            />
        </main>
    );
}